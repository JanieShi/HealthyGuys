...
//    LeftViewController *leftVc = [[LeftViewController alloc] initWithNibName:@"LeftViewController" bundle:nil];
    UIStoryboard *storyBoard = [UIStoryboard storyboardWithName:@"LeftViewController" bundle:nil];
    LeftViewController *leftVc = [storyBoard instantiateInitialViewController];
...
//    RightViewController *rightVc = [[RightViewController alloc] init];
    ...
    MMDrawerController *drawerController = [[MMDrawerController alloc] initWithCenterViewController:tabController leftDrawerViewController: leftVc rightDrawerViewController:nil];
